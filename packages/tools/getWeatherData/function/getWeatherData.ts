...
import { formatEventTime } from '@/packages/tools/getWeatherData/function/common/utils';
import type {
	IWeatherData,
	IGetWeatherDataParams,
} from '@/packages/tools/getWeatherData/function/common/interfaces';
import {
	getGeoDataFromApi,
	getWeatherDataFromApi,
} from '@/packages/tools/getWeatherData/function/common/api';
