...
import { getFormattedWeatherData } from '@/packages/tools/getWeatherData/function/common/utils';
import { type IApiResponseWeatherData } from '@/packages/tools/getWeatherData/function/common/interfaces';
interface IParams {
	units: Unit;
	apiKey: string;
	latitude: number;
