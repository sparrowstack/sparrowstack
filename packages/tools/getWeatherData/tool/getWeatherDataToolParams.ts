import { getWeatherData } from '@/packages/tools/getWeatherData/function/getWeatherData';
...
import type { IGetWeatherDataParams } from '@/packages/tools/getWeatherData/function/common/interfaces';
import {
	PropertyType,
	type IToolParams,
	/* type IRuntimeParams, */
} from '@/packages/sparrowstack/tool';
