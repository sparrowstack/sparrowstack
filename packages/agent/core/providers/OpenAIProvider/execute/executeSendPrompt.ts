...
import { Role } from '@/packages/agent/core/ChatMessage/common/enums';
...
import { toModelResponse } from '@/packages/agent/core/providers/OpenAIProvider/adapters/toModelResponse';
